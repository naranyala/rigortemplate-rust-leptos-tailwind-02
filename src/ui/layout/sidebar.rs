            ...
            if is_open.get() { "translate-x-0" } else { "-translate-x-full md:translate-x-0" }
             ...
             <div class="relative group">
                     ...
                     <input
                         ...
                         class="w-full pl-9 pr-10 py-2 bg-surface-100 dark:bg-surface-800 text-sm text-surface-900 dark:text-white rounded-xl border border-surface-200 dark:border-surface-700 focus:ring-2 focus:ring-accent-500 focus:border-transparent outline-none transition-all"
                         on:input=move |ev| {
                          ...
                          if !search.get().is_empty() {
                              view! {
                                  <button
                                      ...
                                      class="absolute inset-y-0 right-2 flex items-center pr-2 text-surface-400 hover:text-surface-600 group-focus-within:text-accent-500 transition-colors"
                                  >
                                      "✕"
                                  </button>
                              }
